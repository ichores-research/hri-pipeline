...
class DatasetLoader():
    ...
    def get_dynamic(self, data, flags):
        ...
        #np.save('~/Documents/tmp.npy', Xpalm)
        #Xpalm = np.load('~/Documents/tmp.npy', allow_pickle=True)
        #Xpalm.shape
        '''
...
if __name__ == '__main__':
    path = os.path.expanduser("~/teleop_2_ws/build/gesture_detector/gesture_detector/gesture_data/")
